...
# For Geography selectbox, get categories from the OneHotEncoder
# onehot_encoder_geo.categories_ is a list of arrays, one per feature.
geography_options = onehot_encoder_geo.categories_[0]
...
# Create input DataFrame with numerical and label encoded features
input_data = pd.DataFrame({
    'CreditScore': [credit_score],
